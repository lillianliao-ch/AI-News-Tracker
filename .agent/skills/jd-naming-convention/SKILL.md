...
- **前缀**：大写英文字母，代表公司
- **数字**：3位，从 001 开始顺序递增，不跳号
- **示例**：`MMX001`, `ALI222`, `BT029`, `XHS001`
...
| 错误示例 | 问题 | 正确格式 |
|:---|:---|:---|
| `M1`, `M2` | 前缀不规范，MiniMax 应用 `MMX` | `MMX001`, `MMX002` |
| `MMX1` | 缺少零填充 | `MMX001` |
| `minimax001` | 前缀应大写 | `MMX001` |
| `xhs_020` | 历史格式，新增应统一大写 | `XHS020` |
